...
weight_folder = "weights"  # Specify the folder where you want to save the weights
os.makedirs(weight_folder, exist_ok=True)  # Create the folder if it doesn't exist

# Save the model's state dictionary
weight_path = os.path.join(weight_folder, 'custom_model_weights.pth')
torch.save(custom_model.state_dict(), weight_path)
